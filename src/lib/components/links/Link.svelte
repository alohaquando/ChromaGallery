...
<a
	class="{customClasses} relative max-w-fit flex items-center cursor-pointer"
	{href}
>
	<svelte:component class="{typeClass} bg-gradient-to-b from-white to-white" this={component}>
		<slot />
	</svelte:component>
</a>

...
<div
	class="{customClass} {animationClass} w-full px-6 py-10 bg-neutral-700 bg-opacity-50 rounded-2xl backdrop-blur-lg flex-col justify-center items-center gap-6 inline-flex duration-0 ease-out origin-top"
>

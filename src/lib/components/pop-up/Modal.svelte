...
<div
        class="{animation} container mx-auto px-6 relative top-5 z-40 w-screen h-[95vh] backdrop-blur-md bg-gradient-to-b from-neutral-900 via-black/40 via-90% to-black/0 flex rounded-t-3xl overflow-clip flex-col"
>

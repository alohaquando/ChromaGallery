...
<div
        class="{customClass} relative top-0 z-40 w-screen min-h-screen backdrop-blur-md bg-gradient-to-b from-neutral-900 via-black/40 via-90% to-black/0 flex border-t-4 border-white/20 {transition? 'animate-flyUp' : ''} flex-col overflow-y-scrolls"
>

<script>
	...
	export let active = Active.False;
</script>

<button
	class="{customClass} px-3 py-2 flex-col justify-center items-center gap-1 inline-flex line-clamp-1 overflow-visible ease-out duration-300 text-white text-sm text-center leading-[14px] relative

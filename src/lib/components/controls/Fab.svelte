...
<svelte:element
	class="{customClasses} {sizeClasses} {hoverEffect} flex-col  rounded-full border border-white border-opacity-30 backdrop-blur-sm justify-center items-center gap-2 inline-flex overflow-visible duration-300

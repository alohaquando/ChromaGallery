...
<svelte:element
        class="{customClasses} {sizeClasses} {hoverEffect} shrink-0 text-center flex-col  rounded-full border border-white border-opacity-30 justify-center items-center gap-2 inline-flex overflow-visible duration-300 relative

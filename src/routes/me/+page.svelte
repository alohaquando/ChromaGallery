...
{:else}
	...
	<div class="w-full flex flex-col justify-center items-center relative">
		...
		<div class="pt-14 flex justify-center gap-9">
			<Fab class="relative" icon="faCircleUser" size="lg">Sign me<br>in</Fab>
			<Fab class="mt-20 relative" icon="faSparkles" size="lg"
			>Become a<br>member
			</Fab
			>
		</div>

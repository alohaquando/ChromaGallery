<script lang="ts">
	...
	let flavorText: string[] = [
		'creative', 'captivating', 'inspiring', 'mesmerizing', 'breathtaking',
		'exquisite', 'phenomenal', 'majestic', 'enchanting', 'splendid',
		'harmonious', 'evocative', 'masterful', 'stunning', 'dazzling',
		'transcendent', 'awe-inspiring', 'radiant', 'spellbinding', 'sensational',
		'magnificent', 'riveting', 'astounding', 'marvelous', 'elegant',
		'mind-blowing', 'impressive', 'exceptional', 'riveting', 'sublime',
		'mysterious', 'glorious', 'dynamic', 'poignant', 'serene',
		'awe-striking', 'brilliant', 'enrapturing', 'lush', 'innovative',
		'evocative', 'rich', 'vibrant', 'surreal', 'graceful',
		'whimsical', 'ethereal', 'delightful', 'awe-inducing', 'inventive'
	];
	...
	let images: string[] = [
		'https://images.unsplash.com/photo-1703340020770-889bfc85f038?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'https://images.unsplash.com/photo-1682687221006-b7fd60cf9dd0?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'https://images.unsplash.com/photo-1699180134120-fe19a5a775df?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'https://images.unsplash.com/photo-1701762292571-2875f1e522b6?q=80&w=2187&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 'https://images.unsplash.com/photo-1703028408757-a95781e09832?q=80&w=2187&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
	];
...
<div
	class="w-screen mx-auto h-screen overflow-clip ">
